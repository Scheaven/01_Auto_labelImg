本项目FORK自原版的LabelImg 源github地址 https://github.com/heartexlabs/labelImg
项目在原来项目(18年左右时的版本)的基础上为满足个人使用二次开发
二次开发的目的是为尽可能的节约人力成本，最大限度的利用基础模型资源
更新功能包括 自动保存、根据需求删选图像、模型自动标注、视频类数据辅助标注等功能
该项目为开源基础上进行，禁止任何的商业用途
如果涉及版权问题，由项目工具使用人负责，如果版权人禁止使用，请立即停止使用并删除相关代码，原始版权归原作者所有
